...
class DeviceCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('devices_category_id')->type('select')->model('App\Models\devicesCategory')->attribute('name')->entity('devicesCategory'); // notice the name is the foreign key attribute
